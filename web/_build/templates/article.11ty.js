...
var require_formatDistanceToNow = __commonJS({
  "node_modules/date-fns/formatDistanceToNow/index.js"(exports2, module2) {
    ...
    exports2.default = formatDistanceToNow2;
...
// src/templates/article/article.template.tsx
...
function Article({ article }) {
  ...
  const formattedDate = (0, import_date_fns2.differenceInDays)(new Date(publishedAt), new Date()) > 3 ? (0, import_date_fns2.formatDistanceToNow)(new Date(publishedAt), { locale: nl_default }) : (0, import_date_fns2.format)(new Date(publishedAt), "d MMMM yyyy", { locale: nl_default });
  return /* @__PURE__ */ a("main", {
    className: "article"
  }, /* @__PURE__ */ a("article", null, /* @__PURE__ */ a("h1", null, title), mainImage && /* @__PURE__ */ a(Image, {
    image: mainImage
  }), /* @__PURE__ */ a("div", {
    className: "article__info"
  }, /* @__PURE__ */ a("time", {
    dateTime: publishedAt.toString()
  }, formattedDate)), /* @__PURE__ */ a("div", {
    className: "article__body"
  }, /* @__PURE__ */ a(BlockContent, {
    blocks: body
  }))));
}
module.exports = {
  ...
  data: {
    ...
    permalink: ({ article }) => createArticleUrl(article)
  }
};
/*
object-assign

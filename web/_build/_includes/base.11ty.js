...
// src/layouts/base.layout.tsx
function BaseLayout({ content, lang = "nl", layoutCss, page }) {
  ...
  }), /* @__PURE__ */ a("title", null, "Document"), cssPaths.map((path) => /* @__PURE__ */ a("link", {
    rel: "stylesheet",
    href: path
  }))), /* @__PURE__ */ a("body", null, content, /* @__PURE__ */ a("script", {
    src: "/javascript/main.js"
  })));
}
var render = BaseLayout;
